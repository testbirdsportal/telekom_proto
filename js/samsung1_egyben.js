...
var valSlider2 = [0,9890/24,1690];
var valSlider = [1970, 1970, 2610, 3410, 3470, 3840, 5310, 5340,7810, 14810, 19440];
	var text0 = ['Move XS díjcsomag','Fun S Aranytárskártya díjcsomag','Like S díjcsomag','Move S díjcsomag','Eco Surf díjcsomag','Move M Aranytárskártya díjcsomag','Next S Aranytárskártya 2 év hűséggel','Move M díjcsomag','Next S 2 év hűséggel készülékkel díjcsomag','Next M 2 év hűséggel készülékkel díjcsomag','Next XL 2 év hűséggel díjcsomag'];
	var text1 = ['30 MB','50 MB','2 GB','200 MB','50 MB','500 MB','1 GB','500 MB','1 GB','1 GB','6 GB'];
	var text2 = ['internet','internet','internet','internet','internet','internet','internet','internet','internet','internet','internet','internet','internet','internet','internet'];
	var text3 = ['100%-ban felhasználható','100%-ban lebeszélhető','100%-ban lebeszélhető','100%-ban felhasználható','100%-ban lebeszélhető','100%-ban felhasználható','Korlátlan beszélgetés és SMS','100%-ban felhasználható','Korlátlan beszélgesés és SMS','Korlátlan beszélgetés és SMS','Korlátlan beszélgetés és SMS'];
...
function move_tooltip(point,bool = true){
	if(point == 0){
		...
		maradek /= 2;
		maradek *= point;
		$('.tooltip_arrow').css('left',point*(tooltip/2)+'px');
		$('.own_tooltip').css('left',maradek+'px');
...
function change_ar(){
	$('input[name="ar"]').change(function(){
		...
		if(ertek == 'egy_osszegben'){
			...
			window.location.replace("samsung1_reszlet.html");
