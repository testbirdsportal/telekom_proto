...
var valSlider = [1970, 1970, 2610, 3410, 3470, 3840, 5310, 5340, 7810, 14810, 19440];
	...
	var text1 = ['50 MB','30 MB','2 GB','200 MB','50 MB','500 MB','1 GB','500 MB','1 GB','1 GB','6 GB'];
	var text2 = ['internet','internet','internet','internet','internet','internet','internet','internet','internet','internet','internet'];
	var text3 = ['100%-ban lebeszélhető','100%-ban felhasználható','100%-ban lebeszélhető','100%-ban felhasználható','100%-ban lebeszélhető','100%-ban felhasználható','Korlátlan beszélgetés és SMS','100%-ban felhasználható','Korlátlan beszélgetés és SMS','Korlátlan beszélgetés és SMS','Korlátlan beszélgetés és SMS'];
...
function getFelsoAr(felso){
	var a = [4990, 6690, 8390, 9190, 9990, 10690];
...
function move_tooltip2(point,bool = true){
	if(point == 0){
		...
		maradek /= 10;
		maradek *= point;
		$('.tooltip_arrow2').css('left',point*(tooltip/10)+point*1.4+'px');
		$('.own_tooltip2').css('left',maradek+'px');
...
function change_ar(){
	$('input[name="ar"]').change(function(){
		...
		if(ertek == 'egy_osszegben'){
			...
			$('.top_egyosszeg').hide();
			$('.kezdoreszlet').show();
			$('.keszulek_torlesztoreszlet').show();
		}
	});
}
