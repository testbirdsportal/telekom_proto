...
var valSlider = [1970, 1970, 2610, 3410, 3470, 3840, 5310, 5340, 7810, 14810, 17810, 19440];
	var text0 = ['Move XS díjcsomag','Fun S Aranytárskártya díjcsomag','Like S díjcsomag','Move S díjcsomag','Eco Surf díjcsomag','Move M Aranytárskártya díjcsomag','Next S Aranytárskártya 2 év hűséggel díjcsomag','Move M díjcsomag','Next S 2 év hűséggel készülékkel díjcsomag','Next M 2 év hűséggel készülékkel díjcsomag','Next M készülékkel díjcsomag','Next XL 2 év hűséggel díjcsomag'];
	var text1 = ['30 MB','50 MB','2 GB','200 MB','50 MB','500 MB','1 GB','500 MB','1 GB','1 GB','1 GB','6 GB'];
	...
	var text3 = ['100%-ban felhasználható','100%-ban lebeszélhető','100%-ban lebeszélhető','100%-ban felhasználható','100%-ban lebeszélhető','100%-ban felhasználható','Korlátlan beszélgetés és SMS','100%-ban felhasználható','Korlátlan beszélgetés és SMS','Korlátlan beszélgetés és SMS','Korlátlan beszélgetés és SMS','Korlátlan beszélgetés és SMS'];
	var text4 = ['havi díj','és felhasználható SMS-ekre belföldön','és felhasználható SMS-ekre belföldön','havi díj','és felhasználható SMS-ekre belföldön','havi díj','Telekom mobilhálózatán belül','havi díj','Telekom mobilhálózatán belül','belföldön','belföldön','belföldön'];
...
function getFelsoAr(felso){
	var a = [0, 490, 1490, 1990,2990,3990];
	return numberParser(24*a[felso]);
}
//alsó csúszka értékét adja meg
function getAlsoAr(also){
	var b = [1970, 1970, 2610, 3410, 3470, 3840, 5310, 5340, 7810, 14810, 17810, 19440];
...
function move_tooltip2(point,bool = true){
	if(point == 0){
		...
		maradek /= 11;
		maradek *= point;
		$('.tooltip_arrow2').css('left',point*(tooltip/11)+point*1.4+'px');
		$('.own_tooltip2').css('left',maradek+'px');
